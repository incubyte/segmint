...
const Hero = () => {
  return (
    <section
      id="main-content"
      className="relative overflow-hidden bg-white pt-12 pb-16 sm:pt-16 md:pt-20 lg:pt-8"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="mt-6 text-lg sm:text-xl text-gray-600 max-w-2xl">
              Our AI learns your unique persona—style, values, and audience—by analyzing
              your existing content and guiding you through discovery. Receive tailored
              post ideas and drafts that truly sound like you, making authentic engagement
              effortless.
            </p>
